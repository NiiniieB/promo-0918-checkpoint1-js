...
function minMax(array){
  ...
  for (i=0; i<test.length; i++)
    ...
    let tableauMinMax = [leMin, leMax]
    console.log("Dans le tableau [" + test + "] le minimum est " + leMin + " et le maximum " + leMax + ". Pour compléter l'exercice, voici le tableau minMax à 2 entrées: [" + tableauMinMax + "]")
}
